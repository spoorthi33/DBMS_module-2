...
class File{
	...
	protected File(int blockingFactor, int localDepth){
		...
		Bits.sortBuckets(this.dataFileBuckets);
	}
	...
	protected Bucket getBucket(String bitString){
		for(Bucket b : this.dataFileBuckets){
			String trimmedVal = Bits.trim(bitString, b.getLocalDepth());
	...
	protected Bucket getmergingBucket(Bucket bucket){
